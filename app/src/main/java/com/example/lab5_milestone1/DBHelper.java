...
public class DBHelper {
    ...
    public void createTable() {
        sqlLiteDatabase.execSQL("CREATE TABLE IF NOT EXISTS notes" +
    ...
    public ArrayList<Note> readNotes(String username) {
        ...
        createTable();
        Cursor c = sqlLiteDatabase.rawQuery(String.format("SELECT * from notes where username like '%s'", username), null);
    ...
    public void saveNotes(String username, String title, String content, String date) {
        createTable();
        sqlLiteDatabase.execSQL(String.format("INSERT INTO notes (username, date, title, content) VALUES ('%s', '%s', '%s', '%s')", username, date, title, content));
    }

    public void updateNote(String username, String title, String content, String date) {
        createTable();
        sqlLiteDatabase.execSQL(String.format("UPDATE notes set content = '%s', date = '%s' where title = '%s' and username = '%s'", username, date, title, content));
    }
}
